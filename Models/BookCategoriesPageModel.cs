...
namespace Covaci_Adriana_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Covaci_Adriana_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Covaci_Adriana_Lab2Context context,
